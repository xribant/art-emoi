...
class Actu
{
     ...
     * @Assert\NotBlank(message="Veuillez taper un titre")
     */
    private $title;
     ...
     * @Assert\NotBlank(message="Veuillez entrer le texte de l'évènement")
     */
    private $content;
    ...
    /**
     * @Vich\UploadableField(mapping="actu_image", fileNameProperty="imageName")
     * @Assert\File(
     *     maxSize="2M",
