 ...
 */
final class Version20220217080254 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE workshop_video ADD workshop_id INT NOT NULL');
        $this->addSql('ALTER TABLE workshop_video ADD CONSTRAINT FK_944589361FDCE57C FOREIGN KEY (workshop_id) REFERENCES workshop (id)');
        $this->addSql('CREATE INDEX IDX_944589361FDCE57C ON workshop_video (workshop_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_944589361FDCE57C ON workshop_video');
        $this->addSql('ALTER TABLE workshop_video DROP workshop_id, CHANGE title title VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE link link VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
