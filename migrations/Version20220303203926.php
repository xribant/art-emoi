 ...
 */
final class Version20220303203926 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event CHANGE uid uid VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE workshop_infos ADD duration VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE animator animator VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
